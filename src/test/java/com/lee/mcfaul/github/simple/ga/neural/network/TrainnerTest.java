...
import com.lee.mcfaul.github.simple.ga.neural.network.categories.Categories;
...
public class TrainnerTest {
	...
	@Category(Categories.UnitTest.class) @Test public void dummyTestForBuild() {
	...
	@Category(Categories.FunctionalTest.class) @Test public void dummyFunctionalTest() {
		int x = 0;
		for (int i = 0; i < 10; i++) {
			x++;
		}
